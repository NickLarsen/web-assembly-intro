(module
  ...
  (export "_fflush" $Ea)
  (export "_round" $Oa)
  (export "_gaussianBlur" $ta)
  (export "_pthread_self" $Pa)
  (export "_memset" $Ka)
  (export "_malloc" $Ga)
  (export "_memcpy" $Na)
  ...
  (export "dynCall_ii" $Qa)
  (export "dynCall_iiii" $Ra)
  (export "dynCall_vi" $Sa)
  (table $Ta $ua $Ua $Ba $Aa $xa $Va $ya)
  ...
  (func $ta (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32) (param $4 i32)
    (local $5 i32)
    (local $6 f64)
    (local $7 i32)
    (local $8 i32)
  ...
  (func $Ra (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32) (result i32)
    (call_indirect $FUNCSIG$iiii
      (i32.add
        (i32.and
          (get_local $0)
  ...
  (func $Qa (param $0 i32) (param $1 i32) (result i32)
  ...
  (func $Oa (param $0 f64) (result f64)
    (select
      (f64.floor
        (f64.add
          (get_local $0)
